# Odoo Development with DF Devspaces
...
python3 odoo-bin -r odoo -w 111 --db_host localhost
```

## Running Odoo via Docker-Compose file
...
### Requirements
 - The project should be cloned from https://github.com/trilogy-group/odoo.git
...
- At this point you must be inside the docker container. From here you can continue from section `6. Install dependencies:`
